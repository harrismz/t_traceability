...
<head>
  ...
  <?php
	        ...
	        elseif($page == 'singlepart'){
	          ...
	          if(in_array($page.'.php', $thispages2)){
	            include_once($page_dir2.'/'.$page.'.php');
	          } else {
	        ...
	        elseif($_REQUEST['content'] == 'modellotno'){
	          ...
	          if(in_array($page3.'.php', $thispages3)){
	            include_once($page_dir3.'/'.$page3.'.php');
	          } else {
	        ...
	        elseif($_REQUEST['content'] == 'symptom'){
	          ...
	          if(in_array($page4.'.php', $thispages4)){
	            include_once($page_dir4.'/'.$page4.'.php');
	          } else {
