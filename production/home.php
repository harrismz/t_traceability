<div class="row tile_count">
	<?php include "production/carousel_info.php"?>
</div>
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="dashboard_graph">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<div class="demo-placeholder" id="chart_plot_01"></div>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-12 bg-white">
					...
					<div>
						...
						<div class="">
							<div class="progress progress_sm" style="width: 76%;">
								<div class="progress-bar bg-green" data-transitiongoal="80" role="progressbar"></div>
							</div>
						</div>
					</div>
					<div>
						...
						<div class="">
							<div class="progress progress_sm" style="width: 76%;">
								<div class="progress-bar bg-green" data-transitiongoal="60" role="progressbar"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-6">
					<div>
						...
						<div class="">
							<div class="progress progress_sm" style="width: 76%;">
								<div class="progress-bar bg-green" data-transitiongoal="40" role="progressbar"></div>
							</div>
						</div>
					</div>
					<div>
						...
						<div class="">
							<div class="progress progress_sm" style="width: 76%;">
								<div class="progress-bar bg-green" data-transitiongoal="50" role="progressbar"></div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="x_panel tile fixed_height_320 overflow_hidden">
			...
			<div class="x_content">
				<table class="" style="width:100%">
					...
					<tr>
						<td>
							<canvas class="canvasDoughnut" height="140" style="margin: 15px 10px 10px 0" width="140"></canvas>
						</td>
						<td>
			...
			<div class="x_content">
				<div class="dashboard-widget-content">
					...
					<div class="sidebar-widget">
						...
						<canvas class="" height="80" id="chart_gauge_01" style="width: 160px; height: 100px;" width="150"></canvas>
						<div class="goal-wrapper">
							<span class="gauge-value pull-left" id="gauge-text">0</span> <span class="gauge-value pull-left">%</span> <span class="goal-value pull-right" id="goal-text">100%</span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="x_panel">
					...
					<div class="x_content">
						<div class="dashboard-widget-content">
							...
							<div class="col-md-8 col-sm-12 col-xs-12" id="world-map-gdp" style="height:230px;"></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="x_panel">
					...
					<div class="x_content">
						<div class="">
							<ul class="to_do">
								<li>
									<p><input class="flat" type="checkbox"> Schedule meeting with new client</p>
								</li>
								<li>
									<p><input class="flat" type="checkbox"> Create email address for new intern</p>
								</li>
								<li>
									<p><input class="flat" type="checkbox"> Have IT fix the network printer</p>
								</li>
								<li>
									<p><input class="flat" type="checkbox"> Copy backups to offsite location</p>
								</li>
								<li>
									<p><input class="flat" type="checkbox"> Food truck fixie locavors mcsweeney</p>
								</li>
								<li>
									<p><input class="flat" type="checkbox"> Food truck fixie locavors mcsweeney</p>
								</li>
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="weather-icon">
									<canvas height="84" id="partly-cloudy-day" width="84"></canvas>
								</div>
							</div>
							<div class="col-sm-8">
						...
						<div class="row weather-days">
							<div class="col-sm-2">
								<div class="daily-weather">
									...
									<canvas height="32" id="clear-day" width="32"></canvas>
									<h5>15 <i>km/h</i></h5>
								</div>
							</div>
							<div class="col-sm-2">
								<div class="daily-weather">
									<h2 class="day">Tue</h2>
									<h3 class="degrees">25</h3>
									<canvas height="32" id="rain" width="32"></canvas>
									<h5>12 <i>km/h</i></h5>
								</div>
							</div>
							<div class="col-sm-2">
								<div class="daily-weather">
									...
									<canvas height="32" id="snow" width="32"></canvas>
									<h5>14 <i>km/h</i></h5>
								</div>
							</div>
							<div class="col-sm-2">
								<div class="daily-weather">
									...
									<canvas height="32" id="sleet" width="32"></canvas>
									<h5>15 <i>km/h</i></h5>
								</div>
							</div>
							<div class="col-sm-2">
								<div class="daily-weather">
									<h2 class="day">Fri</h2>
									<h3 class="degrees">28</h3>
									<canvas height="32" id="wind" width="32"></canvas>
									<h5>11 <i>km/h</i></h5>
								</div>
							</div>
							<div class="col-sm-2">
								<div class="daily-weather">
									...
									<canvas height="32" id="cloudy" width="32"></canvas>
									<h5>10 <i>km/h</i></h5>
								</div>
							</div>
							<div class="clearfix"></div>
