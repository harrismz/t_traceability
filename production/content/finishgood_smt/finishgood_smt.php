...
<script type="text/javascript" src='./my/js/finishgood_smt/pcb_extjs_report.js'></script>
<section>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          ...
          <div class="col-md-4">
            <input type="text" id="pcbmounter" hidden/>
            <button id="dlFinishgood" type="button" class="btn btn-info pull-right" onclick="downloadMounter()">
              <i class="fas fa-download"></i>
              &nbsp;&nbsp;Download
            </button>
          </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          ...
          <div class="col-md-4">
            <button id="dlAOI" type="button" class="btn btn-info pull-right" onclick="downloadAOI()">
              <i class="fas fa-download"></i>
              &nbsp;&nbsp;Download
            </button>
          </div>
  ...
  <div id="report_tab" class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <div id="smtReport" class="extjs_border"></div>
        </div>
      </div>
    </div>
  </div>
