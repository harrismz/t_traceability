  ...
  <div class="page-title">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2><i class="fas fa-search"></i> DC Offset Search <small>Select Category first for search data</small></h2>
        ...
        <div class="x_title">
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <h2>
              ...
              <small> ( AutoLine Zero Inspect 2 ) </small>
            </h2>
          </div>
...
<!-- Function -->
<script type="text/javascript" src='./my/js/measureDcOffset/mDcFunction.js'></script>
<script type="text/javascript" src='./my/js/measureDcOffset/mDcExtjsCall.js'></script>
<script type="text/javascript" src='./my/js/measureDcOffset/mDcSearch.js'></script>
<script type="text/javascript" src='./my/js/measureDcOffset/mDcOffset.js'></script>