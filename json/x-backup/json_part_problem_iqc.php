<?php
	...
	/**	run query **/
		...
		//and convert(varchar(10), a.prod_date, 120)  BETWEEN DATEADD (day , -3 , $prod_date ) AND DATEADD (day , +3 , $prod_date ) FOR FG AND ELSE
		//and convert(varchar(10), a.prod_date, 120) BETWEEN DATEADD (day , -3 , getdate() ) AND DATEADD (day , +3 , getdate() )
