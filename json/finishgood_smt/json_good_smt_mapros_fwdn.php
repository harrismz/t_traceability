<?php
    ...
    // $sql        = "declare @totalcount as int; EXEC traceability_smt_fwdn $start, $limit, '{$boardid}', @totalcount=@totalcount out;";
    $sql        = "declare @totalcount as int; EXEC traceability_smt_fwdn_rev1 '{$boardid}'";
    $rs         = $db->Execute($sql);
