<?php
    ...
    // $sql        = "declare @totalcount as int; EXEC traceability_smt_avntest $start, $limit, '{$boardid}', @totalcount=@totalcount out;";
    $sql        = "EXEC traceability_smt_avntest_rev1 '{$boardid}'";
    $rs         = $db->Execute($sql);
