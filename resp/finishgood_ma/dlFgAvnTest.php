<?php
	...
	*/
	...
	//	execute query
		$sql = "EXEC download_avntest '{$valModelName}','{$valLotNo}','{$valSerialNo}','{$valDummySerial}'";
		$rs = $db->Execute($sql);
		...
		$fname = "Traceability_Finishgood_Insp_AVNTEST{$fmodel}{$flotno}{$fserial}{$fdummy}.csv";
		...
		$headers = 'MODEL, LOT NO / SERIAL NO, AVNTEST ID, INSPECT DATE, PCB SERIAL, JIG NO, JUDGE, INSP TIME, ARTFILENAME, NG CONTENT, M/C Name' . "\n";
		fwrite($fp,$headers);
