...
Ext.onReady(function() {
  ...
  //           })*/
	...
	Ext.create('Ext.Button',{
	    ...
	    renderTo: btnsearch,
	    handler: function() {
	        // var a = Ext.getElementById('finishgood_model').getValue();
	        var a = "aaa";
	        // var b = Ext.getElementById('finishgood_serial').getValue();
	        var b = "bbb";
					alert(a + b);
	    }
	});
	...
	// 											datastore.proxy.setExtraParam('valprocess', Ext.getCmp('valprocess').getValue());
	// 											datastore.proxy.setExtraParam('valpartno', 	Ext.getCmp('valpartno').getValue());
	// 											datastore.proxy.setExtraParam('valreelno', 	Ext.getCmp('valreelno').getValue());
