Ext.onReady(function() {
	...
	//	=======================================================    DATASTORE    =====================================
		var storeRejectionTU = Ext.create('Ext.data.Store',{
			storeId	: 'storeRejectionTU',
			model	: 'modelRejectionTU',
			autoLoad: true,
			pageSize: itemperpage,
			proxy   : {
				type    : 'ajax',
				url     : 'json/touchUpRejection/json_touchUpRejection.php',
				extraParams: {
					valmodel: '',
					valserial: '',
					vallotno: '',
		...
		// });
	//	=======================================================    GRID    ==========================================
		var gridRejectionTU = Ext.create('Ext.grid.Panel', {
			id 				: 'gridRejectionTU',
			renderTo		: mDcOffset,
			autoWidth 	 	: '100%',
			maxHeight	 	: 420,
			columnLines 	: true,
			store 			: storeRejectionTU,
			plugins 		: 'gridfilters',
    		viewConfig	: {
				stripeRows 			: true,
