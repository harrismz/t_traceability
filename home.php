  ...
  <?php
   	...
   	<!-- <script type="text/javascript">
  		$(document).ready(function(){
  			...
  			alert($host);
  			//window.location.replace($host/indexsss.php);
  			return false;
  		});
  	</script> -->
</head>
        ...
        <?php include "production/top_menu.php"?>
			...
			<div class="right_col" role="main">
				...
				<?php 	if(empty($_REQUEST['content'])){
						...
						elseif($_REQUEST['content'] == "measureDcOffset"){
								$page_dir11 = 'production/content/measureDcOffset';
								$thispages11 = scandir($page_dir11);
								unset($thispages11[0], $thispages11[11]);
								$page11 = $_REQUEST['content'];
								if(in_array($page11.'.php', $thispages11)){
						...
						elseif($_REQUEST['content'] == "modellotno"){
				      	...
				      	elseif($_REQUEST['content'] == "measurement"){
							$page_dir11 = 'production/content/measurement';
							$thispages11 = scandir($page_dir11);
							unset($thispages11[0], $thispages11[11]);
							$page11 = $_REQUEST['content'];
							if(in_array($page11.'.php', $thispages11)){
				      	...
				      	elseif($_REQUEST['content'] == "finishgood_test"){
							$page_dir11 = 'production/content/finishgood';
							$thispages11 = scandir($page_dir11);
							unset($thispages11[0], $thispages11[11]);
							$page11 = $_REQUEST['content'];
